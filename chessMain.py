...
def highlightSquares(screen,gs,validMoves,sqSelected):
    ...
    if gs.inCheck():
        ...
        s.fill(p.Color('red'))
        if gs.whiteToPlay:
            screen.blit(s,(gs.whiteKingLocation[1]*SQUARE_SIZE,gs.whiteKingLocation[0]*SQUARE_SIZE))
        else:
            screen.blit(s,(gs.blackKingLocation[1]*SQUARE_SIZE,gs.blackKingLocation[0]*SQUARE_SIZE))
